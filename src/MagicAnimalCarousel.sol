...
contract MagicAnimalCarousel {
    uint16 constant public MAX_CAPACITY = type(uint16).max; // 0xFFFF
    ...
    uint256 constant NEXT_ID_MASK = uint256(type(uint16).max) << 160; // 0xFFFF0000000000000000000000000000000000000000
    uint256 constant OWNER_MASK = uint256(type(uint160).max); // 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
